...
import 'package:interface_zenith/Services/storage.dart';
            ...
            Stack(
              children: <Widget>[
                FadeAnimation(1.5, -50.0,
                  Container(
                    margin: EdgeInsetsDirectional.fromSTEB(15, 180, 15, 50),
                    height:600,
                      ...
                      child:ListView(
                          children: <Widget>[
                            ...
                            FadeAnimation(2.5, -25.0,
                              Container(
                                margin: EdgeInsetsDirectional.fromSTEB(20, 60, 20, 10),
                                child: TextFormField(
                            ...
                            FadeAnimation(2.5, -45.0,
                              Container(
                                margin: EdgeInsetsDirectional.fromSTEB(20, 10, 20, 0),

                                child: TextFormField(
                                  validator: (val) => val.length < 6 ? 'Senha deve conter no mínimo 6 digitos' : null,
                                  onChanged: (val){
                                    setState(() => senha = val);
                                  },
                                  obscureText: true,
                                  ...
                                  Container(
                                    ...
                                    child: SizedBox.expand(
                                      child: FlatButton(
                                        ...
                                        onPressed: () async {
                                          setState(() => valida = _formKey.currentState.validate());

                                          if(valida){
                                            setState(() => loading = true);

                                            if(imageFile != null){// assim o usuário não é obrigado a escolher uma imagem
                                              imageURL = await _store.uploadFile(imageFile);
                                            }

                                            dynamic result = await _auth.register(name, imageURL, email, senha);

                                            if(result == null){
                                              loading = false;
                                              setState(() => error = "Ocorreu algum erro, por favor tente novamente");
                                            }
                                          }
                                        },
                                      ),
                        ...
                        child: CircleAvatar(
                          ...
                          child: ClipOval(
                            child: SizedBox(
                              height: 180.0,
                              width: 180.0,
                              child: (imageFile != null) ? Image.file(imageFile, fit: BoxFit.fill,) : Icon(
                                Icons.person,
                                color:Colors.grey,
                                size: 100,
                              ),
